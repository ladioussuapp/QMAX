...
{
    public class UserSettingResponse:Protocol
    {
        /// <summary>
        ///  设置key-value
        /// </summary>
        ...
        public UserSettingResponse(Dictionary<string,string> settingValueMap)
        {
        ...
        {
            return string.Format("[UserSettingResponse]:settingValueMap={0}",settingValueMap);
        }
    }
}
