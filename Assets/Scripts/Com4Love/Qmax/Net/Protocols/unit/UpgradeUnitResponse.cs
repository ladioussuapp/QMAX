...
{
    public class UpgradeUnitResponse:Protocol
    {
        /// <summary>
        ///  升级前的id
        /// </summary>
        ...
        public UpgradeUnitResponse()
        {
        }
        public UpgradeUnitResponse(int beforeUnitId,int afterUnitId,ValueResultListResponse valueResultList)
        {
        ...
        {
            return string.Format("[UpgradeUnitResponse]:beforeUnitId={0},afterUnitId={1},valueResultList={2}",beforeUnitId,afterUnitId,valueResultList);
        }
    }
}
