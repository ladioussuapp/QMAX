...
public class FMOD_Listener : MonoBehaviour 
{
	...
	{		
		...
		{
			string bankPath = String.Format("jar:file://{0}!/assets/{1}", Application.dataPath, fileName);
			...
			using (var www = new WWW(bankPath))
			{
				...
				{
					FMOD.Studio.UnityUtil.LogError(String.Format("Bank {0} encountered a loading error {1}", fileName, www.error));
